...
echo "Launch job"
python3 segmentation_school.py --option train --project project_name/ --base_dir /blue/pinaki.sarder/username/folder --wsi_ext '.svs,.ndpi,.scn' --classNum 6 --one_network True 
#
echo "All Done!"
