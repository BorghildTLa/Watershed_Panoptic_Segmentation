...
if __name__ == '__main__':
    ...
    parser.add_argument('--base_dir', dest='base_dir', default=os.getcwd(),type=str,
        help='base directory of project folders')
    ...
    parser.add_argument('--boxSizeHR', dest='boxSizeHR', default=600 ,type=int,
        help='size of high resolution blocks')
    parser.add_argument('--downsampleRateHR', dest='downsampleRateHR', default=1 ,type=float,
        help='reduce image resolution to 1/downsample rate')

    ### Params for augmenting data ###
    #High resolution
    parser.add_argument('--aug_HR', dest='aug_HR', default=0 ,type=int,
    ...
    parser.add_argument('--saveIntervals', dest='saveIntervals', default=1 ,type=int,
    ...
    parser.add_argument('--min_size', dest='min_size', default=[0,54400,32000,960,2400] ,type=int,
